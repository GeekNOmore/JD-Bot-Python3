...
class JDSpider:
    ...
    def order_info(self, submit=False):
        ...
        data = {
            ...
            'vendorRemarks': [],    # 订单备注    [{"venderId":"632952","remark":""}]
...
if __name__ == '__main__':
    ...
    # help message
    parser = argparse.ArgumentParser(description='Simulate to login Jing Dong, and buy good automatically')
    parser.add_argument('-a', '--area',
                        help='Area ID, like: 1_72_2799_0 for Beijing', default='')
    parser.add_argument('-g', '--good',
                        help='Good ID, copy the link of the good, the id is the string after item.jd.com/', default='')
    parser.add_argument('-c', '--count', 
    					type=int,
                        help='The quantity to buy', default=1)
    parser.add_argument('-w', '--wait',
                        type=int, default=1000,
                        help='Flush time interval, unit MS. Too small may cause problem.')
